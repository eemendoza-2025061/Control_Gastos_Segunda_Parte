...
@Component({
      ...
      <main class="main-content">
        ...
        <section class="summary-cards">
          <div class="card stat-card">
            ...
            <h2>$0.00</h2>
            <p class="trend"><span>0%</span> este mes</p>
          </div>
          ...
          <div class="card stat-card">
            ...
            <h2>0</h2>
            <p class="trend"><span>0%</span> esta semana</p>
          </div>
          ...
          <div class="card stat-card">
            ...
            <h2>$0.00</h2>
            <p class="trend"><span>0%</span> alcanzado</p>
          </div>
        </section>
  ...
  styles: [`
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .icon.amber { background-color: rgba(245, 158, 11, 0.15); }
    .icon.cyan { background-color: rgba(6, 182, 212, 0.15); }
    .icon.pink { background-color: rgba(236, 72, 153, 0.15); }
